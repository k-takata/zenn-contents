...
今回の新NSISインストーラーは[v9.2.0699](https://github.com/vim/vim-win32-installer/releases/tag/v9.2.0699)から採用されています。（ただし、コマンドラインオプションのサポートは[v9.2.07xx](https://github.com/vim/vim-win32-installer/releases/tag/v9.2.07xx)から）
